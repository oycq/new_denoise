...
class DispMetric(BaseMetric):
    ...
    def process(self, data_batch, data_samples: Sequence[dict]) -> None:
        ...
        for i in range(len(data_samples)):
            ...
            gt_disp = data_batch['data_samples'][i].metainfo['disp_gt']
            gt_valid = data_batch['data_samples'][i].metainfo['valid']
            self.results.append((pred_disp, gt_disp, gt_valid))
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for pred_disp, gt_disp, gt_valid in results:
            for key, value in self.eval_metrics(pred_disp, gt_disp, gt_valid).items():
