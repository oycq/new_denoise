...
class Driving(BaseStereoDataset):
    """Driving subset dataset.

    Args:
        pass_style (str): Pass style for Driving dataset, and it has 2
    ...
    def __init__(self,
        ...
        setattr(self, self.UNIQUE_NAME_KEY, self.pass_style)
    ...
    def _get_data_dir(self) -> None:
        ...
        img1s_dirs_ = glob(
            osp.join(self.data_root, pass_dir + '/*/*/*/left/'))
        img1s_dirs += img1s_dirs_

        img2s_dirs_ = glob(
            osp.join(self.data_root, pass_dir + '/*/*/*/right/'))
        img2s_dirs += img2s_dirs_

        disp_dirs_ = glob(
            osp.join(self.data_root, 'disparity' + '/*/*/*/left/'))
