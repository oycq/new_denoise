...
class KITTI2012(BaseStereoDataset):
    ...
    def _get_data_dir(self) -> None:
        ...
        # In KITTI 2012, data in `image_0` is left image data
        self.img1_dir = osp.join(self.data_root, 'image_0')
        self.img2_dir = osp.join(self.data_root, 'image_1')
        self.disp_dir = osp.join(self.data_root, 'disp_occ')
