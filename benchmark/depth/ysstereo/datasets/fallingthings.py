...
class FallingThings(BaseStereoDataset):
    """FallingThings subset dataset.
    ...
    def _get_data_dir(self) -> None:
        ...
        self.disp_suffix = '.left.depth.png'
        self.img1_suffix = '.left.jpg'
        self.img2_suffix = '.right.jpg'
        ...
        img1s_dirs_ = glob(
            osp.join(self.data_root, 'fat/single/*/*/'))
        img1s_dirs += img1s_dirs_
        img1s_dirs_ = glob(
            osp.join(self.data_root, 'fat/mixed/*/'))
        img1s_dirs += img1s_dirs_
