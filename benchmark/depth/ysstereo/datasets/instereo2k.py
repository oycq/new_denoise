...
class InStereo2K(BaseStereoDataset):
    ...
    def _get_data_dir(self) -> None:
        ...
        self.disp_suffix = 'left_disp.png'
        self.img1_suffix = 'left.png'
        self.img2_suffix = 'right.png'

        img1s_dirs = []
        img2s_dirs = []
        disp_dirs = []

        folder = "test" if self.test_mode else "part*"
        img1s_dirs_ = glob(
            osp.join(self.data_root, folder+'/*/'))
