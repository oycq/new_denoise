...
class ThreeDKenBurns(BaseStereoDataset):
    """ThreeDKenBurns dataset for training. 
    ...
    def _get_data_dir(self) -> None:
        ...
        self.disp_suffix = 'l-depth.exr'
        self.img1_suffix = 'l-image.png'
        self.img2_suffix = 'r-image.png'
