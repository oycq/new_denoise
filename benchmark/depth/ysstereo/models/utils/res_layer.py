...
from mmcv.cnn import (build_activation_layer, build_conv_layer,
                      build_norm_layer, build_plugin_layer, ConvModule)
from mmengine.model import BaseModel

class DwiseResidual(BaseModel):
    """Depth-wise conv block for ResNet."""
    ...
    def __init__(self,
        ...
        super(DwiseResidual, self).__init__()
...
class InvertedResidual(BaseModel):
